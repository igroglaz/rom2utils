	...
	unlink("$FN2");
       ...
       if (file_exists($ban_path)){
	     ...
	     if ($buffer[$i]!=$banstring[$i])
          ...
          {
             unlink($ban_path);
             $old_ban_path = "C:\Allods2\Chr\\OLDBAN\\".$login.".ban";
...
sleep(5);
    ...
    case "Разблокировать":
        $lgn = $_POST['login'];
	$lgn = trim($lgn);
	$file = "d:/Games/Allods/Chr/".$lgn[0]."/".$lgn.".lgn" ;
	$shell = "unlock.exe D:/Games/Allods/Chr/".$lgn[0]."/".$lgn.".lgn" ;
