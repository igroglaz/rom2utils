...
"0E0E"=>0, #"Scroll Acid Stream",
"0E19"=>0, #"Scroll Bless",
"0E0C"=>0, #"Scroll Blizzard",
"0E1B"=>0, #"Scroll Control Spirit",
"0E21"=>0, #"Scroll Curse",
"0E13"=>0, #"Scroll Darkness",
"0E15"=>0, #"Scroll Diamond Dust",
"0E1F"=>0, #"Scroll Drain Life",
"0E06"=>0, #"Scroll Fire Arrow",
"0E07"=>0, #"Scroll Fire Ball",
"0E08"=>0, #"Scroll Fire Wall",
"0E1A"=>0, #"Scroll Haste",
"0E1D"=>0, #"Scroll Heal",
"0E0A"=>0, #"Scroll Ice Missile",
"0E11"=>0, #"Scroll Invisibility",
"0E14"=>0, #"Scroll Light",
"0E0F"=>0, #"Scroll Lightning",
"0E0B"=>0, #"Scroll Poison Cloud",
"0E10"=>0, #"Scroll Prismatic Spray",
"0E12"=>0, #"Scroll Protection from Air",
"0E18"=>0, #"Scroll Protection from Earth",
"0E09"=>0, #"Scroll Protection from Fire",
"0E0D"=>0, #"Scroll Protection from Water",
"0E20"=>0, #"Scroll Shield",
"0E22"=>0, #"Scroll Slow",
"0E17"=>0, #"Scroll Stone Curse",
"0E1E"=>0, #"Scroll Summon",
"0E1C"=>0, #"Scroll Teleport",
"0E16"=>0, #"Scroll Wall of Earth",
"0E2B"=>0, #"SuperScroll Acid Stream",
"0E36"=>0, #"SuperScroll Bless",
"0E29"=>0, #"SuperScroll Blizzard",
"0E38"=>0, #"SuperScroll Control Spirit",
"0E3E"=>0, #"SuperScroll Curse",
"0E30"=>0, #"SuperScroll Darkness",
"0E32"=>0, #"SuperScroll Diamond Dust",
"0E3C"=>0, #"SuperScroll Drain Life",
"0E23"=>0, #"SuperScroll Fire Arrow",
"0E24"=>0, #"SuperScroll Fire Ball",
"0E25"=>0, #"SuperScroll Fire Wall",
"0E37"=>0, #"SuperScroll Haste",
"0E3A"=>0, #"SuperScroll Heal",
"0E27"=>0, #"SuperScroll Ice Missile",
"0E2E"=>0, #"SuperScroll Invisibility",
"0E31"=>0, #"SuperScroll Light",
"0E2C"=>0, #"SuperScroll Lightning",
...
"716C"=>0, #"Very Rare Meteoric War Hammer"
 ...
 @sps_disable = ( #сила заклов в вещах 0-100
  ...
  0,#"Protection from Earth", # защита от магии земли
 ...
 @book_disable = ( #ИЗУЧЕННЫЕ ЗАКЛЫ  0 - запрет, 1 - можно 
  ...
  0, #"Fire Arrow",            # огненная стрела 
  0, #"Fire Ball",             # огненный шар
  0, #"Fire Wall",             # огненная стена
  0, #"Protection from Fire",  # защита от магии огня
  0, #"Ice Missile",           # ледяная стрела
  0, #"Poison Cloud",          # ядовитый туман
  0, #"Blizzard",              # град
  0, #"Protection from Water", # защита от магии воды
  0, #"Acid Stream",           # кислотная атака
  ...
  0, #"Darkness",              # тьма
  0, #"Light",                 # свечение
  0, #"Diamond Dust",          # каменная стрела
  0, #"Wall of Earth",         # каменная стена
  0, #"Stone Curse",           # каменное проклятие
...
$spell_skill=-1;
 ...
 {  	 
	...
	if(($key=="08h")&&($value>1)) {return 1}; # healthregeneration
	if(($key=="0Bh")&&($value>1)) {return 1}; # manaregeneration
...
$log_dir = "C:\\Allods2\\plscript\\serv4_log\\";
